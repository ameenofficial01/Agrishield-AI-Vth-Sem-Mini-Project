...
with open('src/data/images.ts', 'w', encoding='utf-8') as f:
    ...
    f.write('export const FALLBACK_IMAGE = "https://images.unsplash.com/photo-1500651230702-0e2d8a49d4ad?auto=format&fit=crop&w=400&q=80";\n\n')
    f.write('export const cropImages: Record<string, string> = ' + json.dumps(crop_photos, indent=2) + ';\n\n')
    f.write('export const pestImages: Record<string, string> = ' + json.dumps(pest_photos, indent=2) + ';\n\n')
    f.write('''export function getCropImage(crop: string): string {
...
print("Generated src/data/images.ts with real photographs!")
